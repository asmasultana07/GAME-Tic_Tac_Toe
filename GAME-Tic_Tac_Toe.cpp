...
int main()
{
    ...
    cout << "MODE 0: Player vs computer = 0\t    PLAYER= 'X' & COMPUTER='O'"<< endl;
    cout << "MODE 1: Computer vs computer= 1" <<endl << endl ;
    ...
    if(x == 0)
    {
        while (game_is_done(Grid)==false)
        {
            ...
            ///input position occupaid or not ?
            ...
            if (flag == false)
            {
                cout << "Already played this position. Please try another position" << endl;
                continue;
            }
